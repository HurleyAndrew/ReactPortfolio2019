          ...
          <div className="wegmansWrapper">
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                ...
                <div className="rightDescriptionTitle">
            ...
            <div className="wegmansTriRow wegmansFullWidth">
              <div className="wegmansTriItemFirst ">
                <img
                  ...
                  alt="project image"
                />
                <h1>Individual Weather Events</h1>
                <p>
              ...
              <div className="wegmansTriItemThird ">
                <img
                  ...
                  alt="project image"
                />
                <h1>Weather Event Information</h1>
                <p>
            ...
            <div className="wegmansFullWidth weatherAnimationContainer">
              <img
                src={require('../images/wegmansImages/weatherAnimation1.jpg')}
                alt="project image"
                className="weatherAnimationImage1"
              />
              <img
                src={require('../images/wegmansImages/weatherAnimation2.jpg')}
                alt="project image"
                className="weatherAnimationImage2"
              />
              <img
                src={require('../images/wegmansImages/weatherAnimation3.jpg')}
                alt="project image"
                className="weatherAnimationImage3"
              />
            </div>
          </div>
