...
import heroVideo from '../images/bsidePhotos/herovideos/woodworkingHero.mp4'
      ...
      <div>
        ...
        <div className="App noScrollBehavior">
          ...
          <video
            ...
            muted
            loop
            poster={require('./../images/bsidePhotos/posters/woodworking.jpg')}
          >
          ...
          <div className="wegmansWrapper ">
            ...
            <div className="leftTagContainer leftTagContainerFix wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={require('./../images/bsidePhotos/woodworking1.jpg')}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="leftTagContainer leftTagContainerFix wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={require('./../images/bsidePhotos/woodworking2.jpg')}
                    alt="project"
                    loading="lazy"
                  />
                </div>
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={require('./../images/bsidePhotos/woodworking3.jpg')}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="leftTagContainer leftTagContainerFix wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite margin-bottom ">
                <div className="rightDescriptionImage">
                  <img
                    src={require('./../images/bsidePhotos/woodworking4.jpg')}
                    alt="project"
                    loading="lazy"
                  />
                </div>
