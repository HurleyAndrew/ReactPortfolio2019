        ...
        <div className="App noScrollBehavior">
          ...
          <div className="wegmansWrapper">
            ...
            <img
              ...
              src={"/images/symbiosisImages/symbiosisHero.jpg"}
              alt="wegmans hero"
            />
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/symbiosisImages/symbiosis1.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/symbiosisImages/symbiosis2.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="wegmansTriRow wegmansFullWidth">
              <div className="wegmansTriItemFirst ">
                <img
                  src={"/images/symbiosisImages/symbiosis3.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
              ...
              <div className="wegmansTriItemSecond ">
                <img
                  src={"/images/symbiosisImages/symbiosis4.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
              ...
              <div className="wegmansTriItemThird ">
                <img
                  src={"/images/symbiosisImages/symbiosis5.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/symbiosisImages/symbiosis6.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="wegmansFullWidth weatherAnimationContainer">
              ...
              >
                <source
                  src={"/images/symbiosisImages/symbiosisDemo.mp4"}
                  type="video/mp4"
                ></source>
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/symbiosisImages/symbiosis7.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
