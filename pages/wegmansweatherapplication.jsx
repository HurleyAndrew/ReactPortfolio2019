        ...
        <div className="App">
          ...
          <div className="wegmansWrapper">
            ...
            <img
              ...
              src={"/images/wegmansImages/wegmansProjectHero.jpg"}
              alt="wegmans hero"
            />
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/wegmansImages/needs.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/wegmansImages/framework1.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/wegmansImages/framework2.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/wegmansImages/framework3.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="leftTagContainer wegmansFullWidth">
              ...
              <div className="rightDescriptionWhite">
                <div className="rightDescriptionImage">
                  <img
                    src={"/images/wegmansImages/siteMap.jpg"}
                    alt="project"
                    loading="lazy"
                  />
                </div>
            ...
            <div className="wegmansTriRow wegmansFullWidth">
              <div className="wegmansTriItemFirst ">
                <img
                  src={"/images/wegmansImages/dashboardTri1.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
              ...
              <div className="wegmansTriItemSecond ">
                <img
                  src={"/images/wegmansImages/dashboardTri2.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
              ...
              <div className="wegmansTriItemThird ">
                <img
                  src={"/images/wegmansImages/dashboardTri3.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
            ...
            <div className="wegmansTriRow wegmansFullWidth">
              <div className="wegmansTriItemFirst ">
                <img
                  src={"/images/wegmansImages/dashboardTri4.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
              ...
              <div className="wegmansTriItemSecond ">
                <img
                  src={"/images/wegmansImages/dashboardTri5.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
              ...
              <div className="wegmansTriItemThird ">
                <img
                  src={"/images/wegmansImages/dashboardTri6.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
            ...
            <div className="wegmansTriRow wegmansFullWidth">
              <div className="wegmansTriItemFirst ">
                <img
                  src={"/images/wegmansImages/dashboardTri7.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
              ...
              <div className="wegmansTriItemSecond ">
                <img
                  src={"/images/wegmansImages/dashboardTri8.jpg"}
                  alt="project"
                  loading="lazy"
                />
                <h1
            ...
            <div className="wegmansFullWidth weatherAnimationContainer">
              <video width="320" height="240" controls className="wegmansDemo">
                <source
                  src={"/images/wegmansImages/wegmansDemo.mp4"}
                  type="video/mp4"
                ></source>
